...
export const agentsIntro = {
  ...
  body:
    "Bring your own model API keys. reveren is the standards layer between your codebase and whichever coding agent you use today. Switch agents next quarter and your playbooks come with you.",
};
