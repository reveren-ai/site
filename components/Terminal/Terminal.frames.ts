...
export const frames: TerminalFrame[] = [
  ...
  { text: "↳ Writing .playbooks/", className: "info", delay: 1900 },
  { text: "  · plan-product.playbook.md", className: "muted", delay: 2200 },
  { text: "  · plan-engineering.playbook.md", className: "muted", delay: 2450 },
  { text: "  · ship.playbook.md", className: "muted", delay: 2700 },
  { text: "  · review.playbook.md", className: "muted", delay: 2950 },
  { text: "↳ Writing .reveren/config.ts", className: "info", delay: 3400 },
  { text: "↳ Wiring package.json scripts", className: "info", delay: 3800 },
  { text: "✓ Ready. 12 playbooks installed.", className: "success", delay: 4400 },
